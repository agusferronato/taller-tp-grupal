...
void MainWindow::setupPages() {
    ...
    connect(loginPage, &LoginPage::connectRequested, this, &MainWindow::onStartGame);
    connect(loginPage, &LoginPage::backToMenuRequested, this, &MainWindow::showMainMenu);

    connect(charCreationPage, &CharacterCreationPage::characterCreated, this, &MainWindow::onCharacterCreated);
    connect(charCreationPage, &CharacterCreationPage::backToMenuRequested, this, &MainWindow::showMainMenu);
}
...
void MainWindow::onCharacterCreated(const QString &username, const QString &password, const QString &name, const QString &race, const QString &playerClass) {
    ClientData data;
    data.username = username.toStdString();
    data.password = password.toStdString();
