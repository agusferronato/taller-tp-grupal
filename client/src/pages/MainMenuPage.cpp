    ...
    : BackgroundPage(parent)
{
    ...
    logo->setPixmap(logoPixmap.scaled(400, 200, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    ...
    connect(continueBtn, &QPushButton::clicked, this, &MainMenuPage::continueGame);
...
void MainMenuPage::resizeEvent(QResizeEvent *event) {
    ...
    if (!logoPixmap.isNull()) {
        ...
        logo->setPixmap(logoPixmap.scaled(w, h, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    }
}
