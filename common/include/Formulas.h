...
class Formulas {
public:
  static uint32_t calcularVidaMax(uint32_t constitucion, const std::string &raza,
                                   const std::string &clase, uint32_t nivel);
  static uint32_t calcularManaMax(uint32_t inteligencia, const std::string &raza,
                                   const std::string &clase, uint32_t nivel);
