...
using ServerEventDTO = std::variant<
    AttackReceivedEventDTO, ChatMessageEventDTO, NPCAppearedEventDTO,
    NpcDefeatedEventDTO, NPCMovedEventDTO, NPCStoppedEventDTO,
    PlayerMovedEventDTO, RegisterPlayerEventDTO, PlayerListEventDTO,
    PlayerAppearedEventDTO, PlayerStoppedEventDTO, TextureInfoEventDTO,
    PrivateMessageEventDTO, PlayerInfoEventDTO, PlayerRemovedEventDTO,
    InventoryUpdateEventDTO, GlobalChatMessageEventDTO,
    CityEntityAppearedEventDTO, CityEntityMovedEventDTO,
    CityEntityStoppedEventDTO, GroundItemAppearedEventDTO,
    GroundItemRemovedEventDTO, GroundItemsListEventDTO, PlayerDieEventDTO,
    PlayerResurrectEventDTO, LoginResultEventDTO>;
