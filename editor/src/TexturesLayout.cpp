...
TexturesLayout::TexturesLayout(QWidget *parent) : QWidget(parent) {
  initTexturesLayout();
}
...
void TexturesLayout::initTexturesLayout() {
  ...
  title->setStyleSheet(
      "font-size: 13px; font-weight: 600; color: palette(windowText);");
  ...
  line->setStyleSheet("color: palette(mid); background: palette(mid); "
...
QWidget *TexturesLayout::createTextureItem(const TextureData &info) {
  ...
  imgFrame->setStyleSheet("border: 1px solid palette(mid);"
                          "border-radius: 6px;"
                          "background: palette(alternateBase);");
  ...
  nameLabel->setStyleSheet("font-size: 12px; font-weight: 600; color: "
                           "palette(windowText); border:none;");
